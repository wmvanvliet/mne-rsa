...
project = u'mne-rsa'
copyright = u'2020, Aalto University'
...
latex_documents = [
    (master_doc, 'mne-rsa.tex', u'MNE-RSA Documentation',
...
man_pages = [
    (master_doc, 'mne_rsa', u'MNE-RSA Documentation',
     ['Marijn van Vliet'], 1)
]
...
texinfo_documents = [
    (master_doc, 'mne_rsa', u'MNE-RSA Documentation',
     'Marijn van Vliet', 'mne_rsa', 'Representational Similarity Analysis',
     'Miscellaneous'),
]
...
intersphinx_mapping = {'python': ('https://docs.python.org/3/', None),
                       ...
                       'mne_rsa': ('https://users.aalto.fi/~vanvlm1/mne-rsa/',
                                   None),
